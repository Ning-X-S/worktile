...
$(".coment .project-stat-head li").on("click",function (){
    var flag=$(this).index();
//    flag+=1;
    $("#jk .project-stat-head li").removeClass("current");
    $(this).addClass("current");
    $("#jk .project-stat-footer").css("display","none")
    $("#jk .project-stat-footer:eq("+flag+")").css("display","block");
})
